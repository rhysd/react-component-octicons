...
const OCTICON_SVGS: { [T in OcticonSymbol]: JSX.Element } = {
    alert: (
        <svg id="octicon-alert" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    'arrow-up': (
        <svg id="octicon-arrow-up" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor" fill="currentcolor">
            <path fill-rule="evenodd" d="M5 3L0 9h3v4h4V9h3z" />
        </svg>
    ),
    beaker: (
        <svg id="octicon-beaker" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    bell: (
        <svg id="octicon-bell" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    bold: (
        <svg id="octicon-bold" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    book: (
        <svg id="octicon-book" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    bookmark: (
        <svg id="octicon-bookmark" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    browser: (
        <svg id="octicon-browser" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    bug: (
        <svg id="octicon-bug" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    calendar: (
        <svg id="octicon-calendar" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    check: (
        <svg id="octicon-check" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z" />
        </svg>
    ),
    checklist: (
        <svg
            id="octicon-checklist"
            viewBox="0 0 16 16"
            width="16"
            height="16"
            stroke="currentcolor"
    ...
    clippy: (
        <svg id="octicon-clippy" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    clock: (
        <svg id="octicon-clock" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    code: (
        <svg id="octicon-code" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    comment: (
        <svg id="octicon-comment" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    dash: (
        <svg id="octicon-dash" viewBox="0 0 8 16" width="8" height="16" stroke="currentcolor" fill="currentcolor">
            <path fill-rule="evenodd" d="M0 7v2h8V7z" />
        </svg>
    ),
    dashboard: (
        <svg
            id="octicon-dashboard"
            viewBox="0 0 16 16"
            width="16"
            height="16"
            stroke="currentcolor"
    ...
    database: (
        <svg id="octicon-database" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    'device-camera-video': (
        <svg
            id="octicon-device-camera-video"
            viewBox="0 0 16 16"
            width="16"
            height="16"
            stroke="currentcolor"
    ...
    diff: (
        <svg id="octicon-diff" viewBox="0 0 13 16" width="13" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    ellipsis: (
        <svg id="octicon-ellipsis" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    eye: (
        <svg id="octicon-eye" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    file: (
        <svg id="octicon-file" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    'file-pdf': (
        <svg id="octicon-file-pdf" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    'file-symlink-directory': (
        <svg
            id="octicon-file-symlink-directory"
            viewBox="0 0 14 16"
            width="14"
            height="16"
            stroke="currentcolor"
    ...
    'file-zip': (
        <svg id="octicon-file-zip" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    flame: (
        <svg id="octicon-flame" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    fold: (
        <svg id="octicon-fold" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    gear: (
        <svg id="octicon-gear" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    gift: (
        <svg id="octicon-gift" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    gist: (
        <svg id="octicon-gist" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    globe: (
        <svg id="octicon-globe" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    grabber: (
        <svg id="octicon-grabber" viewBox="0 0 8 16" width="8" height="16" stroke="currentcolor" fill="currentcolor">
            <path fill-rule="evenodd" d="M8 4v1H0V4h8zM0 8h8V7H0v1zm0 3h8v-1H0v1z" />
        </svg>
    ),
    graph: (
        <svg id="octicon-graph" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path fill-rule="evenodd" d="M16 14v1H0V0h1v14h15zM5 13H3V8h2v5zm4 0H7V3h2v10zm4 0h-2V6h2v7z" />
        </svg>
    ),
    heart: (
        <svg id="octicon-heart" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    history: (
        <svg id="octicon-history" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    home: (
        <svg id="octicon-home" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    hubot: (
        <svg id="octicon-hubot" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    inbox: (
        <svg id="octicon-inbox" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    info: (
        <svg id="octicon-info" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    italic: (
        <svg id="octicon-italic" viewBox="0 0 6 16" width="6" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    jersey: (
        <svg id="octicon-jersey" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    key: (
        <svg id="octicon-key" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    keyboard: (
        <svg id="octicon-keyboard" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    law: (
        <svg id="octicon-law" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    link: (
        <svg id="octicon-link" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    location: (
        <svg id="octicon-location" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    lock: (
        <svg id="octicon-lock" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    mail: (
        <svg id="octicon-mail" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    markdown: (
        <svg id="octicon-markdown" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    mention: (
        <svg id="octicon-mention" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    mirror: (
        <svg id="octicon-mirror" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    mute: (
        <svg id="octicon-mute" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    note: (
        <svg id="octicon-note" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    octoface: (
        <svg id="octicon-octoface" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    package: (
        <svg id="octicon-package" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    paintcan: (
        <svg id="octicon-paintcan" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    pencil: (
        <svg id="octicon-pencil" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    person: (
        <svg id="octicon-person" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    pin: (
        <svg id="octicon-pin" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    plug: (
        <svg id="octicon-plug" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    plus: (
        <svg id="octicon-plus" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path fill-rule="evenodd" d="M12 9H7v5H5V9H0V7h5V2h2v5h5z" />
        </svg>
    ),
    'plus-small': (
        <svg id="octicon-plus-small" viewBox="0 0 7 16" width="7" height="16" stroke="currentcolor" fill="currentcolor">
            <path fill-rule="evenodd" d="M4 7V4H3v3H0v1h3v3h1V8h3V7H4z" />
        </svg>
    ),
    'primitive-dot': (
        <svg
            id="octicon-primitive-dot"
            viewBox="0 0 8 16"
            width="8"
            height="16"
            stroke="currentcolor"
    ...
    project: (
        <svg id="octicon-project" viewBox="0 0 15 16" width="15" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    pulse: (
        <svg id="octicon-pulse" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    question: (
        <svg id="octicon-question" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    quote: (
        <svg id="octicon-quote" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    reply: (
        <svg id="octicon-reply" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path fill-rule="evenodd" d="M6 3.5c3.92.44 8 3.125 8 10-2.312-5.062-4.75-6-8-6V11L.5 5.5 6 0v3.5z" />
        </svg>
    ),
    repo: (
        <svg id="octicon-repo" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    rocket: (
        <svg id="octicon-rocket" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    rss: (
        <svg id="octicon-rss" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    ruby: (
        <svg id="octicon-ruby" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    search: (
        <svg id="octicon-search" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    server: (
        <svg id="octicon-server" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    settings: (
        <svg id="octicon-settings" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    shield: (
        <svg id="octicon-shield" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    'sign-in': (
        <svg id="octicon-sign-in" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    'sign-out': (
        <svg id="octicon-sign-out" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    smiley: (
        <svg id="octicon-smiley" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    squirrel: (
        <svg id="octicon-squirrel" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    star: (
        <svg id="octicon-star" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    stop: (
        <svg id="octicon-stop" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    sync: (
        <svg id="octicon-sync" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    tag: (
        <svg id="octicon-tag" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    tasklist: (
        <svg id="octicon-tasklist" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    terminal: (
        <svg id="octicon-terminal" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    thumbsup: (
        <svg id="octicon-thumbsup" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    tools: (
        <svg id="octicon-tools" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    trashcan: (
        <svg id="octicon-trashcan" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    unfold: (
        <svg id="octicon-unfold" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    unmute: (
        <svg id="octicon-unmute" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    verified: (
        <svg id="octicon-verified" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    versions: (
        <svg id="octicon-versions" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    watch: (
        <svg id="octicon-watch" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    x: (
        <svg id="octicon-x" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    zap: (
        <svg id="octicon-zap" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor" fill="currentcolor">
