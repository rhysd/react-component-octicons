...
const OCTICON_SVGS: {[name: string]: JSX.Element} = {
  "alert": <svg id="octicon-alert" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "arrow-down": <svg id="octicon-arrow-down" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M7 7V3H3v4H0l5 6 5-6z"/>
  </svg>,
  "arrow-left": <svg id="octicon-arrow-left" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M6 3L0 8l6 5v-3h4V6H6z"/>
  </svg>,
  "arrow-right": <svg id="octicon-arrow-right" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M10 8L4 3v3H0v4h4v3z"/>
  </svg>,
  "arrow-small-down": <svg id="octicon-arrow-small-down" viewBox="0 0 6 16" width="6" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M4 7V5H2v2H0l3 4 3-4z"/>
  </svg>,
  "arrow-small-left": <svg id="octicon-arrow-small-left" viewBox="0 0 6 16" width="6" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M4 7V5L0 8l4 3V9h2V7z"/>
  </svg>,
  "arrow-small-right": <svg id="octicon-arrow-small-right" viewBox="0 0 6 16" width="6" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M6 8L2 5v2H0v2h2v2z"/>
  </svg>,
  "arrow-small-up": <svg id="octicon-arrow-small-up" viewBox="0 0 6 16" width="6" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M3 5L0 9h2v2h2V9h2z"/>
  </svg>,
  "arrow-up": <svg id="octicon-arrow-up" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M5 3L0 9h3v4h4V9h3z"/>
  </svg>,
  "beaker": <svg id="octicon-beaker" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "bell": <svg id="octicon-bell" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "bold": <svg id="octicon-bold" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor">
  ...
  "book": <svg id="octicon-book" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "bookmark": <svg id="octicon-bookmark" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor">
  ...
  "briefcase": <svg id="octicon-briefcase" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "broadcast": <svg id="octicon-broadcast" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "browser": <svg id="octicon-browser" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "bug": <svg id="octicon-bug" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "calendar": <svg id="octicon-calendar" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "check": <svg id="octicon-check" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/>
  </svg>,
  "checklist": <svg id="octicon-checklist" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "chevron-down": <svg id="octicon-chevron-down" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M5 11L0 6l1.5-1.5L5 8.25 8.5 4.5 10 6z"/>
  </svg>,
  "chevron-left": <svg id="octicon-chevron-left" viewBox="0 0 8 16" width="8" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M5.5 3L7 4.5 3.25 8 7 11.5 5.5 13l-5-5z"/>
  </svg>,
  "chevron-right": <svg id="octicon-chevron-right" viewBox="0 0 8 16" width="8" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M7.5 8l-5 5L1 11.5 4.75 8 1 4.5 2.5 3z"/>
  </svg>,
  "chevron-up": <svg id="octicon-chevron-up" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M10 10l-1.5 1.5L5 7.75 1.5 11.5 0 10l5-5z"/>
  </svg>,
  "circle-slash": <svg id="octicon-circle-slash" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "circuit-board": <svg id="octicon-circuit-board" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M3 5c0-.55.45-1 1-1s1 .45 1 1-.45 1-1 1-1-.45-1-1zm8 0c0-.55-.45-1-1-1s-1 .45-1 1 .45 1 1 1 1-.45 1-1zm0 6c0-.55-.45-1-1-1s-1 .45-1 1 .45 1 1 1 1-.45 1-1zm2-10H5v2.17c.36.19.64.47.83.83h2.34c.42-.78 1.33-1.28 2.34-1.05.75.19 1.36.8 1.53 1.55.31 1.38-.72 2.59-2.05 2.59-.8 0-1.48-.44-1.83-1.09H5.83c-.42.8-1.33 1.28-2.34 1.03-.73-.17-1.34-.78-1.52-1.52C1.72 4.49 2.2 3.59 3 3.17V1H1c-.55 0-1 .45-1 1v12c0 .55.45 1 1 1l5-5h2.17c.42-.78 1.33-1.28 2.34-1.05.75.19 1.36.8 1.53 1.55.31 1.38-.72 2.59-2.05 2.59-.8 0-1.48-.44-1.83-1.09H6.99L4 15h9c.55 0 1-.45 1-1V2c0-.55-.45-1-1-1z"/>
  </svg>,
  "clippy": <svg id="octicon-clippy" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M2 13h4v1H2v-1zm5-6H2v1h5V7zm2 3V8l-3 3 3 3v-2h5v-2H9zM4.5 9H2v1h2.5V9zM2 12h2.5v-1H2v1zm9 1h1v2c-.02.28-.11.52-.3.7-.19.18-.42.28-.7.3H1c-.55 0-1-.45-1-1V4c0-.55.45-1 1-1h3c0-1.11.89-2 2-2 1.11 0 2 .89 2 2h3c.55 0 1 .45 1 1v5h-1V6H1v9h10v-2zM2 5h8c0-.55-.45-1-1-1H8c-.55 0-1-.45-1-1s-.45-1-1-1-1 .45-1 1-.45 1-1 1H3c-.55 0-1 .45-1 1z"/>
  </svg>,
  "clock": <svg id="octicon-clock" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "cloud-download": <svg id="octicon-cloud-download" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "cloud-upload": <svg id="octicon-cloud-upload" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "code": <svg id="octicon-code" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M9.5 3L8 4.5 11.5 8 8 11.5 9.5 13 14 8 9.5 3zm-5 0L0 8l4.5 5L6 11.5 2.5 8 6 4.5 4.5 3z"/>
  </svg>,
  "comment": <svg id="octicon-comment" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "comment-discussion": <svg id="octicon-comment-discussion" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "credit-card": <svg id="octicon-credit-card" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "dash": <svg id="octicon-dash" viewBox="0 0 8 16" width="8" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M0 7v2h8V7z"/>
  </svg>,
  "dashboard": <svg id="octicon-dashboard" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "database": <svg id="octicon-database" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "desktop-download": <svg id="octicon-desktop-download" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "device-camera": <svg id="octicon-device-camera" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "device-camera-video": <svg id="octicon-device-camera-video" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "device-desktop": <svg id="octicon-device-desktop" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "device-mobile": <svg id="octicon-device-mobile" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor">
  ...
  "diff": <svg id="octicon-diff" viewBox="0 0 13 16" width="13" height="16" stroke="currentcolor">
  ...
  "diff-added": <svg id="octicon-diff-added" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "diff-ignored": <svg id="octicon-diff-ignored" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "diff-modified": <svg id="octicon-diff-modified" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "diff-removed": <svg id="octicon-diff-removed" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "diff-renamed": <svg id="octicon-diff-renamed" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "ellipsis": <svg id="octicon-ellipsis" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "eye": <svg id="octicon-eye" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "file": <svg id="octicon-file" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "file-binary": <svg id="octicon-file-binary" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "file-code": <svg id="octicon-file-code" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "file-directory": <svg id="octicon-file-directory" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "file-media": <svg id="octicon-file-media" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "file-pdf": <svg id="octicon-file-pdf" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "file-submodule": <svg id="octicon-file-submodule" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "file-symlink-directory": <svg id="octicon-file-symlink-directory" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "file-symlink-file": <svg id="octicon-file-symlink-file" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "file-zip": <svg id="octicon-file-zip" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "flame": <svg id="octicon-flame" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "fold": <svg id="octicon-fold" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "gear": <svg id="octicon-gear" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M14 8.77v-1.6l-1.94-.64-.45-1.09.88-1.84-1.13-1.13-1.81.91-1.09-.45-.69-1.92h-1.6l-.63 1.94-1.11.45-1.84-.88-1.13 1.13.91 1.81-.45 1.09L0 7.23v1.59l1.94.64.45 1.09-.88 1.84 1.13 1.13 1.81-.91 1.09.45.69 1.92h1.59l.63-1.94 1.11-.45 1.84.88 1.13-1.13-.92-1.81.47-1.09L14 8.75v.02zM7 11c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3z"/>
  </svg>,
  "gift": <svg id="octicon-gift" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "gist": <svg id="octicon-gist" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "gist-secret": <svg id="octicon-gist-secret" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "git-branch": <svg id="octicon-git-branch" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor">
  ...
  "git-commit": <svg id="octicon-git-commit" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "git-compare": <svg id="octicon-git-compare" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "git-merge": <svg id="octicon-git-merge" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "git-pull-request": <svg id="octicon-git-pull-request" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "globe": <svg id="octicon-globe" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "grabber": <svg id="octicon-grabber" viewBox="0 0 8 16" width="8" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M8 4v1H0V4h8zM0 8h8V7H0v1zm0 3h8v-1H0v1z"/>
  </svg>,
  "graph": <svg id="octicon-graph" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M16 14v1H0V0h1v14h15zM5 13H3V8h2v5zm4 0H7V3h2v10zm4 0h-2V6h2v7z"/>
  </svg>,
  "heart": <svg id="octicon-heart" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "history": <svg id="octicon-history" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "home": <svg id="octicon-home" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "horizontal-rule": <svg id="octicon-horizontal-rule" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor">
  ...
  "hubot": <svg id="octicon-hubot" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "inbox": <svg id="octicon-inbox" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "info": <svg id="octicon-info" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M6.3 5.69a.942.942 0 0 1-.28-.7c0-.28.09-.52.28-.7.19-.18.42-.28.7-.28.28 0 .52.09.7.28.18.19.28.42.28.7 0 .28-.09.52-.28.7a1 1 0 0 1-.7.3c-.28 0-.52-.11-.7-.3zM8 7.99c-.02-.25-.11-.48-.31-.69-.2-.19-.42-.3-.69-.31H6c-.27.02-.48.13-.69.31-.2.2-.3.44-.31.69h1v3c.02.27.11.5.31.69.2.2.42.31.69.31h1c.27 0 .48-.11.69-.31.2-.19.3-.42.31-.69H8V7.98v.01zM7 2.3c-3.14 0-5.7 2.54-5.7 5.68 0 3.14 2.56 5.7 5.7 5.7s5.7-2.55 5.7-5.7c0-3.15-2.56-5.69-5.7-5.69v.01zM7 .98c3.86 0 7 3.14 7 7s-3.14 7-7 7-7-3.12-7-7 3.14-7 7-7z"/>
  </svg>,
  "issue-closed": <svg id="octicon-issue-closed" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "issue-opened": <svg id="octicon-issue-opened" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "issue-reopened": <svg id="octicon-issue-reopened" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "italic": <svg id="octicon-italic" viewBox="0 0 6 16" width="6" height="16" stroke="currentcolor">
  ...
  "jersey": <svg id="octicon-jersey" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "kebab-horizontal": <svg id="octicon-kebab-horizontal" viewBox="0 0 13 16" width="13" height="16" stroke="currentcolor">
  ...
  "kebab-vertical": <svg id="octicon-kebab-vertical" viewBox="0 0 3 16" width="3" height="16" stroke="currentcolor">
  ...
  "key": <svg id="octicon-key" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "keyboard": <svg id="octicon-keyboard" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "law": <svg id="octicon-law" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "light-bulb": <svg id="octicon-light-bulb" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M6.5 0C3.48 0 1 2.19 1 5c0 .92.55 2.25 1 3 1.34 2.25 1.78 2.78 2 4v1h5v-1c.22-1.22.66-1.75 2-4 .45-.75 1-2.08 1-3 0-2.81-2.48-5-5.5-5zm3.64 7.48c-.25.44-.47.8-.67 1.11-.86 1.41-1.25 2.06-1.45 3.23-.02.05-.02.11-.02.17H5c0-.06 0-.13-.02-.17-.2-1.17-.59-1.83-1.45-3.23-.2-.31-.42-.67-.67-1.11C2.44 6.78 2 5.65 2 5c0-2.2 2.02-4 4.5-4 1.22 0 2.36.42 3.22 1.19C10.55 2.94 11 3.94 11 5c0 .66-.44 1.78-.86 2.48zM4 14h5c-.23 1.14-1.3 2-2.5 2s-2.27-.86-2.5-2z"/>
  </svg>,
  "link": <svg id="octicon-link" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"/>
  </svg>,
  "link-external": <svg id="octicon-link-external" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "list-ordered": <svg id="octicon-list-ordered" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "list-unordered": <svg id="octicon-list-unordered" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "location": <svg id="octicon-location" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "lock": <svg id="octicon-lock" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "logo-gist": <svg id="octicon-logo-gist" viewBox="0 0 25 16" width="25" height="16" stroke="currentcolor">
  ...
  "logo-github": <svg id="octicon-logo-github" viewBox="0 0 45 16" width="45" height="16" stroke="currentcolor">
  ...
  "mail": <svg id="octicon-mail" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "mail-read": <svg id="octicon-mail-read" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "mark-github": <svg id="octicon-mark-github" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0 0 16 8c0-4.42-3.58-8-8-8z"/>
  </svg>,
  "markdown": <svg id="octicon-markdown" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "megaphone": <svg id="octicon-megaphone" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "mention": <svg id="octicon-mention" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "milestone": <svg id="octicon-milestone" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M8 2H6V0h2v2zm4 5H2c-.55 0-1-.45-1-1V4c0-.55.45-1 1-1h10l2 2-2 2zM8 4H6v2h2V4zM6 16h2V8H6v8z"/>
  </svg>,
  "mirror": <svg id="octicon-mirror" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "mortar-board": <svg id="octicon-mortar-board" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "mute": <svg id="octicon-mute" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "no-newline": <svg id="octicon-no-newline" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "note": <svg id="octicon-note" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "octoface": <svg id="octicon-octoface" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "organization": <svg id="octicon-organization" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M16 12.999c0 .439-.45 1-1 1H7.995c-.539 0-.994-.447-.995-.999H1c-.54 0-1-.561-1-1 0-2.634 3-4 3-4s.229-.409 0-1c-.841-.621-1.058-.59-1-3 .058-2.419 1.367-3 2.5-3s2.442.58 2.5 3c.058 2.41-.159 2.379-1 3-.229.59 0 1 0 1s1.549.711 2.42 2.088C9.196 9.369 10 8.999 10 8.999s.229-.409 0-1c-.841-.62-1.058-.59-1-3 .058-2.419 1.367-3 2.5-3s2.437.581 2.495 3c.059 2.41-.158 2.38-1 3-.229.59 0 1 0 1s3.005 1.366 3.005 4"/>
  </svg>,
  "package": <svg id="octicon-package" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "paintcan": <svg id="octicon-paintcan" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "pencil": <svg id="octicon-pencil" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/>
  </svg>,
  "person": <svg id="octicon-person" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "pin": <svg id="octicon-pin" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "plug": <svg id="octicon-plug" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "plus": <svg id="octicon-plus" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M12 9H7v5H5V9H0V7h5V2h2v5h5z"/>
  </svg>,
  "plus-small": <svg id="octicon-plus-small" viewBox="0 0 7 16" width="7" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M4 7V4H3v3H0v1h3v3h1V8h3V7H4z"/>
  </svg>,
  "primitive-dot": <svg id="octicon-primitive-dot" viewBox="0 0 8 16" width="8" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M0 8c0-2.2 1.8-4 4-4s4 1.8 4 4-1.8 4-4 4-4-1.8-4-4z"/>
  </svg>,
  "primitive-square": <svg id="octicon-primitive-square" viewBox="0 0 8 16" width="8" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M8 12H0V4h8z"/>
  </svg>,
  "project": <svg id="octicon-project" viewBox="0 0 15 16" width="15" height="16" stroke="currentcolor">
  ...
  "pulse": <svg id="octicon-pulse" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M11.5 8L8.8 5.4 6.6 8.5 5.5 1.6 2.38 8H0v2h3.6l.9-1.8.9 5.4L9 8.5l1.6 1.5H14V8z"/>
  </svg>,
  "question": <svg id="octicon-question" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "quote": <svg id="octicon-quote" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "radio-tower": <svg id="octicon-radio-tower" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "reply": <svg id="octicon-reply" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M6 3.5c3.92.44 8 3.125 8 10-2.312-5.062-4.75-6-8-6V11L.5 5.5 6 0v3.5z"/>
  </svg>,
  "repo": <svg id="octicon-repo" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "repo-clone": <svg id="octicon-repo-clone" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "repo-force-push": <svg id="octicon-repo-force-push" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "repo-forked": <svg id="octicon-repo-forked" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M8 1a1.993 1.993 0 0 0-1 3.72V6L5 8 3 6V4.72A1.993 1.993 0 0 0 2 1a1.993 1.993 0 0 0-1 3.72V6.5l3 3v1.78A1.993 1.993 0 0 0 5 15a1.993 1.993 0 0 0 1-3.72V9.5l3-3V4.72A1.993 1.993 0 0 0 8 1zM2 4.2C1.34 4.2.8 3.65.8 3c0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm3 10c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm3-10c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2z"/>
  </svg>,
  "repo-pull": <svg id="octicon-repo-pull" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "repo-push": <svg id="octicon-repo-push" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "rocket": <svg id="octicon-rocket" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "rss": <svg id="octicon-rss" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor">
  ...
  "ruby": <svg id="octicon-ruby" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M13 6l-5 5V4h3l2 2zm3 0l-8 8-8-8 4-4h8l4 4zm-8 6.5L14.5 6l-3-3h-7l-3 3L8 12.5z"/>
  </svg>,
  "screen-full": <svg id="octicon-screen-full" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "screen-normal": <svg id="octicon-screen-normal" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "search": <svg id="octicon-search" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "server": <svg id="octicon-server" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "settings": <svg id="octicon-settings" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "shield": <svg id="octicon-shield" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "sign-in": <svg id="octicon-sign-in" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "sign-out": <svg id="octicon-sign-out" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "smiley": <svg id="octicon-smiley" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "squirrel": <svg id="octicon-squirrel" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "star": <svg id="octicon-star" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M14 6l-4.9-.64L7 1 4.9 5.36 0 6l3.6 3.26L2.67 14 7 11.67 11.33 14l-.93-4.74z"/>
  </svg>,
  "stop": <svg id="octicon-stop" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "sync": <svg id="octicon-sync" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "tag": <svg id="octicon-tag" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "tasklist": <svg id="octicon-tasklist" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "telescope": <svg id="octicon-telescope" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "terminal": <svg id="octicon-terminal" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "text-size": <svg id="octicon-text-size" viewBox="0 0 18 16" width="18" height="16" stroke="currentcolor">
  ...
  "three-bars": <svg id="octicon-three-bars" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "thumbsdown": <svg id="octicon-thumbsdown" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "thumbsup": <svg id="octicon-thumbsup" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "tools": <svg id="octicon-tools" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "trashcan": <svg id="octicon-trashcan" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "triangle-down": <svg id="octicon-triangle-down" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M0 5l6 6 6-6z"/>
  </svg>,
  "triangle-left": <svg id="octicon-triangle-left" viewBox="0 0 6 16" width="6" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M6 2L0 8l6 6z"/>
  </svg>,
  "triangle-right": <svg id="octicon-triangle-right" viewBox="0 0 6 16" width="6" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M0 14l6-6-6-6z"/>
  </svg>,
  "triangle-up": <svg id="octicon-triangle-up" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
    <path fill-rule="evenodd" d="M12 11L6 5l-6 6z"/>
  </svg>,
  "unfold": <svg id="octicon-unfold" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "unmute": <svg id="octicon-unmute" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "unverified": <svg id="octicon-unverified" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "verified": <svg id="octicon-verified" viewBox="0 0 16 16" width="16" height="16" stroke="currentcolor">
  ...
  "versions": <svg id="octicon-versions" viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor">
  ...
  "watch": <svg id="octicon-watch" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "x": <svg id="octicon-x" viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor">
  ...
  "zap": <svg id="octicon-zap" viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor">
