...
const OCTICON_SVGS: { [T in OcticonSymbol]: JSX.Element } = {
    ...
    'arrow-down': (
        <svg viewBox="0 0 10 16" width="10" height="16" stroke="currentcolor" fill="currentcolor">
    ...
    'arrow-small-down': (
        <svg viewBox="0 0 6 16" width="6" height="16" stroke="currentcolor" fill="currentcolor">
    ...
    bell: (
        <svg viewBox="0 0 14 16" width="14" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    check: (
        <svg viewBox="0 0 12 16" width="12" height="16" stroke="currentcolor" fill="currentcolor">
    ...
    'chevron-left': (
        <svg viewBox="0 0 8 16" width="8" height="16" stroke="currentcolor" fill="currentcolor">
    ...
    diff: (
        <svg viewBox="0 0 13 16" width="13" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    'kebab-vertical': (
        <svg viewBox="0 0 3 16" width="3" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    'logo-gist': (
        <svg viewBox="0 0 25 16" width="25" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    'logo-github': (
        <svg viewBox="0 0 45 16" width="45" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    'plus-small': (
        <svg viewBox="0 0 7 16" width="7" height="16" stroke="currentcolor" fill="currentcolor">
    ...
    project: (
        <svg viewBox="0 0 15 16" width="15" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
    ...
    'text-size': (
        <svg viewBox="0 0 18 16" width="18" height="16" stroke="currentcolor" fill="currentcolor">
            <path
                fill-rule="evenodd"
